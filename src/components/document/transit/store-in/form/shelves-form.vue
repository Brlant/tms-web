        ...
        <div class="form-header-part">
          ...
          <div class="content">
            <el-row :gutter="20" class="mb-15">
              <el-col :span="12">
                <el-form-item label="入库整装箱数" prop="warehousingWholeNum">
                  <oms-input v-model="form.warehousingWholeNum" type="integer" placeholder="请输入入库整装箱数"></oms-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="入库散装箱数" prop="warehousingBulkNum">
                  <oms-input v-model="form.warehousingBulkNum" type="integer" placeholder="请输入入库散装箱数"></oms-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row class="mb-15">
              <el-form-item label="扫描整装箱码" prop="wholeTraceCodes">
                <oms-input v-model="form.wholeTraceCodes" type="textarea"></oms-input>
              </el-form-item>
            </el-row>
            <el-row>
              <el-form-item label="扫描散装箱码" prop="bulkTraceCodes">
    ...
    save(formName) {
      this.$refs[formName].validate((valid) => {
        ...
        TransferInOrder.shelves(this.form.id, {
          ...
          .catch(err => {
            console.log(err);
            this.$notify.error(err.response.data.msg || '上架失败');
          })
      });
    },
