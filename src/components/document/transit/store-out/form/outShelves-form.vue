      ...
      <el-form ref="form" :rules="rules" :model="form" class="clearfix" label-width="120px" onsubmit="return false">
        <div class="form-header-part">
            ...
            <div class="content">
                ...
                <oms-col label="仓库名称" :rowSpan="span" :value="form.waybillNumber"/>
                <oms-col label="库区名称" :rowSpan="span" :value="form.waybillNumber"/>
                <oms-col label="库位名称" :rowSpan="span" :value="form.waybillNumber"/>
                <oms-col label="状态" :rowSpan="span" :value="form.waybillNumber"/>
                    ...
                    <el-row :gutter="20" class="mb-15">
                        <el-col :span="12">
                            <el-form-item label="入库整装箱数" prop="bulk">
                                <oms-input v-model="form.bulk" type="text" placeholder="请输入入库整装箱数"></oms-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="入库散装箱数" prop="bulk">
                                <oms-input v-model="form.bulk" type="text" placeholder="请输入入库散装箱数"></oms-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row class="mb-15">
