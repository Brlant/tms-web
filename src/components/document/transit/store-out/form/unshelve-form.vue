      ...
      <el-form ref="form" :rules="rules" :model="form" class="clearfix" label-width="120px" onsubmit="return false">
        <div class="form-header-part">
          ...
          <div class="content">
            ...
            <div class="clearfix"></div>
            <oms-col label="仓库名称" :rowSpan="span" :value="form.inStoreName"/>
            <oms-col label="库区名称" :rowSpan="span" :value="form.inStoreAreaName"/>
            <oms-col label="库位名称" :rowSpan="span" :value="form.inStorePointName"/>
